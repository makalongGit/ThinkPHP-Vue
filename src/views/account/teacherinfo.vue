...
<div class="app-container calendar-list-container">
  <div class="filter-container" style="padding-bottom:10px">
    ...
    <el-input @keyup.enter.native="handleFilter" style="width: 200px;" class="filter-item" placeholder="工号查询" v-model="listQuery.student_id">
    </el-input>
  ...
  methods: {
    ...
    handleDownload() {
      ...
      import('@/vendor/Export2Excel').then(excel => {
        const tHeader = ['名称', '工号', '性别', '介绍']
        const filterVal = ['uname', 'uid', 'sex', 'intro']
        const data = this.formatJson(filterVal, this.tableData)
        excel.export_json_to_excel(tHeader, data, '教师数据')
